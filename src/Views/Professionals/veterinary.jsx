                        ...
                        <Form>
                            ...
                            <div className="half-layout">
                                <div className="half-layout__left">
                                    ...
                                    <Field name="birth_date" label={'Data de Nascimento:'} component={FormField} mask={date} />
                                    ...
                                    <Field name="state_veterinary" label={'Estado:'} component={FormField} />
                                    <Field name="crmv" label={'CRMV*:'} component={FormField} />

                                    <div className="default-form__row default-form__row--tworows">
                                        <Field name="licence_mormo" type="number" label={'Habilitação para Mormo*:'} component={FormField} />
                                        <Field name="licence_date" type="text" label={'Portaria Habilitação:'} component={FormField} mask={shortDate} />
                                    </div>
